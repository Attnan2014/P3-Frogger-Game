...
var Player = function() {
    ...
    this.sprite = this.pImages[Math.floor(Math.random()*3)];
...
var score = 0;
//If player swims across the water, reset the game.
function reachEnd() {
...
function gameOver() {
    var removeScore = document.getElementById('score');
        ...
        ctx.font = "30px Cabin Condensed";
        ctx.fillStyle="#000000";
        ctx.fillText("Game Over!", 140, 100);
        ctx.font="30px Cabin Condensed";
        ctx.fillText("Your Score: " + score, 140, 150);
        keyEnabled = false;
}
